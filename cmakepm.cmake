...
function(_pm_download_dependencies SOURCE_DIR BINARY_DIR)
    ...
    execute_process(
        COMMAND
            "${PYTHON_EXECUTABLE}"
            "${CMAKE_CURRENT_SOURCE_DIR}/cmakepm/pm_arti_download.py"
            "${CMAKEPM_TARGET_OS}"
            "${CMAKEPM_TARGET_ARCH}"
...
function(_pm_add_package_auto PACKAGE_NAME PACKAGE_PATH)
    ...
    if(NOT TARGET ${TARGET_IMPORTED_NAME})
        ...
        set_property(TARGET ${TARGET_IMPORTED_NAME} PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${PACKAGE_PATH}/include")
    endif()
